...
#define NRF24_CSN_Port          PORTA
#define NRF24_CSN_DDR           DDRA
#define NRF24_CSN_Mask          (1 << 5)
#define NRF24_CE_Port           PORTA
#define NRF24_CE_DDR            DDRA
#define NRF24_CE_Mask           (1 << 4)
